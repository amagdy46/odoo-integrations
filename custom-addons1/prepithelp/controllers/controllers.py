...
# class Prepithelp(http.Controller):
#     @http.route('/prepithelp/prepithelp', auth='public')
#     def index(self, **kw):
#         return "Hello, world"

#     @http.route('/prepithelp/prepithelp/objects', auth='public')
#     def list(self, **kw):
#         return http.request.render('prepithelp.listing', {
#             'root': '/prepithelp/prepithelp',
#             'objects': http.request.env['prepithelp.prepithelp'].search([]),
#         })

#     @http.route('/prepithelp/prepithelp/objects/<model("prepithelp.prepithelp"):obj>', auth='public')
#     def object(self, obj, **kw):
#         return http.request.render('prepithelp.object', {
#             'object': obj
#         })
